...
ACTOR_HIDDEN_LAYERS = [128, 128]    # Hidden layers for the actor
CRITIC_HIDDEN_LAYERS = [128, 128]   # Hidden layers for the critic
...
REWARD_CRASH =    0.0           # Large penalty for crashing
REWARD_ALIVE =    0.0           # Small reward for staying alive each timestep
REWARD_DISTANCE = 50.0          # Reward/punishment for change of distance between timesteps
REWARD_TARGET =    2.0          # Large reward for reaching the target
REWARD_ANGLE =     1.0          # Reward staying upright (max: upright & -max: upsidedown)
...
EPISODE_MARKER = 100           # Distance between saved model checkpoints

MODEL_PATH = "./models/"   # where to save the model
